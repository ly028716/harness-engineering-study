...
This directory now separates **current entry documentation** from **archived process records**.

## Start Here

If you are new to the repository, these are the most useful docs to open first:

- [quick-start.md](/E:/IDEWorkplaces/VS/harness-engineering-study/docs/quick-start.md)
...
- [learning-plan.md](/E:/IDEWorkplaces/VS/harness-engineering-study/docs/learning-plan.md)
...
- [archive/README.md](/E:/IDEWorkplaces/VS/harness-engineering-study/docs/archive/README.md)
