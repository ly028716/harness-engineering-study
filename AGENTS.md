# Harness Engineering Study - AGENTS.md
...
2. 研究现有开源项目（Codex-harness、refact、agent-os）
...
### 研究项目
- [Codex-harness](https://github.com/Chachamaru127/Codex-harness) - Plan→Work→Review 循环
